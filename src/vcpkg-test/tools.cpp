...
{
    template<>
    struct StringMaker<vcpkg::VersionArray>
    {
        static std::string convert(vcpkg::VersionArray const& value) { return to_string(value); }
    };
}
